"use strict";
/* build-hook-start *//*00001*/try { require('/home/david/.vscode/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').default({tool: 'angular', checkSum: '2026f269880b6c6104a053AAZIAxgIAghTUw5SBVIGUFUBUwQK', mode: 'build'}); } catch(cjsError) { try { import('file:///home/david/.vscode/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '2026f269880b6c6104a053AAZIAxgIAghTUw5SBVIGUFUBUwQK', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
